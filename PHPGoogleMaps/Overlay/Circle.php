...
class Circle extends \PHPGoogleMaps\Overlay\Shape {
	 ...
	 * @return Circle
	 */
	public function __construct( \PHPGoogleMaps\Core\LatLng $center, $radius, array $options=null ) {
		$this->center = $center;
	...
	public static function createFromLatLng( \PHPGoogleMaps\Core\LatLng $center, $radius, array $options=null ) {
