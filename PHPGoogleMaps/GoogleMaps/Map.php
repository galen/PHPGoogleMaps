 ...
 *************************/
	 ...
	 */
	protected function addDirections( \GoogleMaps\Service\Directions $dir ) {
		return $this->directions = new \GoogleMaps\Service\DirectionsDecorator( $dir, $this->map_id );
	}
 ...
 *************************************************/
	...
	protected function addFusionTable( \GoogleMaps\Layer\FusionTable $ft ) {
		return $this->fusion_tables[] = new \GoogleMaps\Layer\FusionTableDecorator( $ft, count( $this->fusion_tables ), $this->map_id );
	}
 ...
 ************************************************/
	 ...
	 * @return void
	 */
	protected function addMapStyle( \GoogleMaps\Overlay\MapStyle $style ) {
	...
	public function addObject( &$object ) {
		...
		switch( get_class( $object ) ) {
			...
			case 'GoogleMaps\Overlay\Rectangle':
				...
				break;
			case 'GoogleMaps\Service\WalkingDirections':
			case 'GoogleMaps\Service\BicyclingDirections':
			case 'GoogleMaps\Service\DrivingDirections':
