...
class Map
{
    ...
    /**
     * Append a library to the collections of libraries that will be loaded
     *
     ...
     * @return string
     */
    public function getStaticMap($format = 'png', array $visible = null)
    {
     ...
     * @return boolean|int
     */
    public function validateStaticMap($format = 'png', array $visible = null)
    {
     ...
     * @return void
     */
    public function printStaticMap($format = 'png', array $visible = null)
    {
     ...
     * @return void
     * @throws Service\GeocodeException
     */
